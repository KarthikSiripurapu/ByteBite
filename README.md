...
<img width="1869" height="892" alt="Screenshot (647)-LAPTOP-82MRRM2S" src="https://github.com/user-attachments/assets/44ce9d25-6fc9-45a0-a23a-de76d45895e7" />
...
>❗Open the frontend first [http://localhost:5174](http://localhost:5174)
...
>❗Open the admin after the frontend. [http://localhost:5173](http://localhost:5173)
